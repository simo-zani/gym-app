...
export function RestScreen({ onExitRequest }: Props) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col" style={{ paddingTop: 'env(safe-area-inset-top)', paddingBottom: '120px' }}>
        ...
        {shuffledTips.length > 0 && (() => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs font-semibold leading-relaxed text-slate-300 text-left">
      ...
      {overviewOpen && (
        <div
          className="absolute inset-0 z-50 flex flex-col bg-bg-0/95 backdrop-blur-sm"
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-3 rounded-2xl px-4 py-3.5 border transition-all ${
                    isNext
                      ...
                      : isDone
                      ? 'border-bg-3/40 bg-bg-1/50 opacity-60'
                      : isCurrentlyResting
                      ? 'border-blueSoft/20 bg-bg-1'
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className={`truncate text-sm font-semibold ${isDone ? 'text-slate-500 line-through' : 'text-slate-200'}`}>
                      {ex.exerciseName}
                    </p>
                  ...
                  {isCurrentlyResting && (
                    <span className="shrink-0 rounded-full bg-blueSoft/15 px-2 py-0.5 text-[10px] font-bold text-blueSoft">
                      RIPOSO
                    </span>
                  )}
                  {isNext && (
